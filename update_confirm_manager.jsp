...
<%
	...
	if(conn == null){
		...
		String sql = "select no,age,name,part from manager where name ='"+name+"'";
...
<ul>
	...
	<input type = "text" name="no" readonly="readonly" value="<%=no%>">
	</li>
	...
	<input type = "text" name="part" placeholder="부서입력"value="<%=part%>">
	</li>
